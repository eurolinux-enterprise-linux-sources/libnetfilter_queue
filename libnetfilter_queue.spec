...
%prep
%setup -q
sed -i 's/libnfnetlink\/linux_nfnetlink/linux\/netfilter\/nfnetlink/' include/libnetfilter_queue/linux_nfnetlink_queue.h
...
%changelog
* Sun Jun 01 2014 Pavel Šimerda <psimerda@redhat.com> - 1.0.1-3
- Resolves: #738244 - provide libnetfilter_queue package for RHEL 6.6
- use a modified EPEL6 spec file
